jQuery.fn.puissance4 = function (puissance4) {
    ...
    if (puissance4.color_j1 === puissance4.color_j2) {
        ...
        function dernierPosVide(col, jeu) {
            indexVide = null;
            for (let index = 0; index < puissance4.row; index++) {
                if (jeu[col][index] === null) {
                    indexVide = index;
                }
            }
            return indexVide;
        ...
        function mostrarJeton(j, a, position) {
            if (jeu[a][position] === null) {
        ...
        function clickHere(nomdudiv) {
            ...
            if ((par % 2) != 0) {
                ...
                let jeton_visible = mostrarJeton(j2, a, position);

                if (jeton_visible === true) {
                    if (verifGagnante(j2)) {
                    ...
                    indicator.style.backgroundColor = puissance4.color_j1;
                    annuler_mouve = true;
                ...
                let jeton_visible = mostrarJeton(j1, a, position);
                if (jeton_visible === true) {
                    if (verifGagnante(j1)) {
                    ...
                    indicator.style.backgroundColor = puissance4.color_j2;
                    annuler_mouve = true;
    ...
    function overColone(coloneShtroumfDiv) {
        let color;
        
        if (par % 2 != 0) {
            color = puissance4.color_j2;
        } else {
            color = puissance4.color_j1;
        }
        // coloneShtroumfDiv.setAttribute("style", 'background-color: ' + color + ';');
        let rect = coloneShtroumfDiv.getBoundingClientRect()
    ...
    for (a = 0; a < puissance4.col; a++) {
        ...
        coloneShtroumfDiv.addEventListener("mouseover", function () {
            overColone(coloneShtroumfDiv);
        });
        ...
        document.querySelector("#tableau > div .colones").appendChild(coloneShtroumfDiv);
    }
    ...
    button_back.addEventListener('click', function () {
        if (annuler_mouve && !win) {
            ...
            annuler(lastA, jeu, lastPosition, null);
            annuler_mouve = false;
        }
    })
